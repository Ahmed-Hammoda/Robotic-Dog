...
def _launch_setup(context, *args, **kwargs):
    ...
    # Include real hardware (sensors and actuators)
    real_hardware = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(str(bringup_share / 'launch' / 'real_hardware.launch.py')),
        launch_arguments={
            'enable_vision': 'true',
