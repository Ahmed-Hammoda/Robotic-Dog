...
class ManualControllerNode(Node):
    def __init__(self) -> None:
        ...
        self.create_subscription(Bool, '/imu/fall_detected', self.fall_callback, 10)
    ...
    def fall_callback(self, msg: Bool) -> None:
...
# this is not a real controller, just a simple mapping from cmd_vel to motor commands for testing purposes
    ...
    def control_loop(self) -> None:
        ...
        cmd.mode = 'fall' if self.fall_detected else self._mode(linear_x, angular_z)
        ...
        status.note = f'lin={linear_x:.2f}, ang={angular_z:.2f}, imu_fall={self.fall_detected}'
