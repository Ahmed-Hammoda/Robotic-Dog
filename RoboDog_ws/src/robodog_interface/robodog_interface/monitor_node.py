...
class MonitorNode(Node):
    ...
    def _build_status_json(self) -> str:
        payload = {
            ...
            'imu': {
                'roll_rad': self._safe_number(self.latest.get('imu_roll_rad', 0.0), 0.0),
                'pitch_rad': self._safe_number(self.latest.get('imu_pitch_rad', 0.0), 0.0),
                'roll_deg': self._safe_number(math.degrees(self.latest.get('imu_roll_rad', 0.0)), 0.0),
                'pitch_deg': self._safe_number(math.degrees(self.latest.get('imu_pitch_rad', 0.0)), 0.0),
            },
            'tf': {
                'map_to_imu': {
